...
class CmfYingkaipiaohuizong extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfYingkaipiaohuizong/index/";
        ...
        $data['CmfYingkaipiaohuizong'] = $this->CmfSellplanmainModel->getYinkaipiaoSum($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYingkaipiaohuizong/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfYingkaipiaohuizong'] = $this->CmfSellplanmainModel->getYinkaipiaoSumDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYingkaipiaohuizong/details",$data);
		} else {
			redirect('/oa/CmfYingkaipiaohuizong/index');
		}
	}
