...
class CmfShoururecord extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfShoururecord/index/";
        ...
        $data['CmfShoururecord'] = $this->CmfAccessprepayModel->getMustAccessPrepay($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfShoururecord/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfShoururecord'] = $this->CmfAccessprepayModel->getMustAccessPrepayDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfShoururecord/details",$data);
		} else {
			redirect('/oa/CmfShoururecord/index');
		}
	}
