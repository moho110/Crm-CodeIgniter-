...
class CmfKehuxinzengzoushi extends MY_AdminController {
	...
	public function index() {
        ...
        $data['CmfCustomer'] = $this->CmfCustomerModel->getRows();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfKehuxinzengzoushi/index",$data);
	}
