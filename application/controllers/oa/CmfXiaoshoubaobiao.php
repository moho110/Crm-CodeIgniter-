...
class CmfXiaoshoubaobiao extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfXiaoshoubaobiao/index/";
        ...
        $data['CmfXiaoshoubaobiao'] = $this->CmfSellplanmainModel->getMustAccessPrepay($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfXiaoshoubaobiao/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfXiaoshoubaobiao'] = $this->CmfSellplanmainModel->getMustAccessPrepayDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfXiaoshoubaobiao/details",$data);
		} else {
			redirect('/oa/CmfXiaoshoubaobiao/index');
		}
	}
