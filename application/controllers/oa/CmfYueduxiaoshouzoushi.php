...
class CmfYueduxiaoshouzoushi extends MY_AdminController {
	...
	public function index() {
        ...
        $data['CmfYueduxiaoshouzoushi'] = $this->CmfSellplanmainModel->getRows();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYueduxiaoshouzoushi/index",$data);
	}
