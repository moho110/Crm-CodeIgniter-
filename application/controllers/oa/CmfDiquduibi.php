...
class CmfDiquduibi extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfDiquduibi/index/";
        ...
        $data['CmfDiquduibi'] = $this->CmfSellplanmainModel->getMustCustomerareaDuibi($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfDiquduibi/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfDiquduibi'] = $this->CmfSellplanmainModel->getMustCustomerareaDuibiDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfDiquduibi/details",$data);
		} else {
			redirect('/oa/CmfDiquduibi/index');
		}
	}
    ...
    public function search() {
        ...
        if(!empty($searchvalue) and !empty($keyword)) {
            $data['CmfDiquduibi'] = $this->CmfSellplanmainModel->getSearch($searchvalue,$keyword);
            $this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfDiquduibi/search-result",$data);
        } else {
            redirect('/oa/CmfDiquduibi/index');
        }
    }
