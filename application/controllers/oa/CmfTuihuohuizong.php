...
class CmfTuihuohuizong extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfTuihuohuizong/index/";
        ...
        $data['CmfTuihuohuizong'] = $this->CmfSellplanmainDetailModel->getMustTuihuoSum($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfTuihuohuizong/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfTuihuohuizong'] = $this->CmfSellplanmainDetailModel->getMustTuihuoSumDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfTuihuohuizong/details",$data);
		} else {
			redirect('/oa/CmfTuihuohuizong/index');
		}
	}
