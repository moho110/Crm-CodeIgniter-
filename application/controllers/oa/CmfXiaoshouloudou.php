...
class CmfXiaoshouloudou extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfXiaoshouloudou/index/";
        ...
        $data['CmfXiaoshouloudou'] = $this->CmfCrmChanceModel->getXiaoShou($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();

		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfXiaoshouloudou/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfXiaoshouloudou'] = $this->CmfCrmChanceModel->getXiaoShouDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfXiaoshouloudou/details",$data);
		} else {
			redirect('/oa/CmfXiaoshouloudou/index');
		}
	}
