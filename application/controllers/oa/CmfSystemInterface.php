...
class CmfSystemInterface extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfSystemInterface/index/";
        ...
        $data['CmfSystemInterface'] = $this->CmfSellplanmainModel->getMustAccessPrepay($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfSystemInterface/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfSystemInterface'] = $this->CmfSellplanmainModel->getMustAccessPrepayDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfSystemInterface/details",$data);
		} else {
			redirect('/oa/CmfSystemInterface/index');
		}
	}
