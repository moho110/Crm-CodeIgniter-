...
class CmfKucunbaojing extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfKucunbaojing/index/";
        ...
        $data['CmfKucunbaojing'] = $this->CmfProductModel->getKucunbaojing($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfKucunbaojing/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfKucunbaojing'] = $this->CmfProductModel->getKucunbaojingDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfKucunbaojing/details",$data);
		} else {
			redirect('/oa/CmfKucunbaojing/index');
		}
