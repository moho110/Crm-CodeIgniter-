...
class CmfGongyingshanggonghuohuizong extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfGongyingshanggonghuohuizong/index/";
        ...
        $data['CmfGongyingshanggonghuohuizong'] = $this->CmfBuyplanmainModel->getMustBuyplanmain($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfGongyingshanggonghuohuizong/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfGongyingshanggonghuohuizong'] = $this->CmfBuyplanmainModel->getMustBuyplanmainDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfGongyingshanggonghuohuizong/details",$data);
		} else {
			redirect('/oa/CmfGongyingshanggonghuohuizong/index');
		}
	}
