...
class CmfMaolihuizong extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfMaolihuizong/index/";
        ...
        $data['CmfMaolihuizong'] = $this->CmfSellplanmainDetailModel->getMustMaoliSum($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfMaolihuizong/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfMaolihuizong'] = $this->CmfSellplanmainDetailModel->getMustMaoliSumDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfMaolihuizong/details",$data);
		} else {
			redirect('/oa/CmfMaolihuizong/index');
		}
	}
