...
class CmfFixedassetAdmin extends MY_AdminController {
	...
	public function index() {
        ...
        $data['CmfFixedasset'] = $this->CmfFixedassetModel->getRows();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfFixedasset/index",$data);
	}
