...
class CmfSalsemanRankingList extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfSalsemanRankingList/index/";
        ...
        $data['CmfSalsemanRankingList'] = $this->CmfCustomerModel->getMustCustomer($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfSalsemanRankingList/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfSalsemanRankingList'] = $this->CmfCustomerModel->getMustCustomerDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfSalsemanRankingList/details",$data);
		} else {
			redirect('/oa/CmfSalsemanRankingList/index');
		}
	}
