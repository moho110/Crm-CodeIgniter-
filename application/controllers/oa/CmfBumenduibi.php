...
class CmfBumenduibi extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfBumenduibi/index/";
        ...
        $data['CmfBumenduibi'] = $this->CmfSellplanmainModel->getMustDepartment($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfBumenduibi/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfBumenduibi'] = $this->CmfSellplanmainModel->getMustDepartmentDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfBumenduibi/details",$data);
		} else {
			redirect('/oa/CmfBumenduibi/index');
		}
	}
    ...
    public function search() {
        ...
        if(!empty($searchvalue) and !empty($keyword)) {
            $data['CmfBumenduibi'] = $this->CmfSellplanmainModel->getSearch($searchvalue,$keyword);
            $this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfBumenduibi/search-result",$data);
        } else {
            redirect('/oa/CmfBumenduibi/index');
        }
    }
