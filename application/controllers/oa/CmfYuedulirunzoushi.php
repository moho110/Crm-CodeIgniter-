...
class CmfYuedulirunzoushi extends MY_AdminController {
	...
	public function index() {
        ...
        $config = array();
        //分页
        $config['base_url'] = base_url() ."index.php/oa/CmfYuedulirunzoushi/index/";
        ...
        $data['CmfYuedulirunzoushi'] = $this->CmfSellplanmainModel->getYueduliruGraph($config['per_page'],$config['per_page']*$page);
        $data['links'] = $this->pagination->create_links();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYuedulirunzoushi/index",$data);
	}
	...
	public function view($id) {
		...
		if(!empty($id)) {
		$data['CmfYuedulirunzoushi'] = $this->CmfSellplanmainModel->getYueduliruGraphDetails($id);
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYuedulirunzoushi/details",$data);
		} else {
			redirect('/oa/CmfYuedulirunzoushi/index');
		}
	}
