...
class CmfYingshoukuanhuizong extends MY_AdminController {
	...
	public function index() {
        ...
        $data['CmfAccessbank'] = $this->CmfAccessbankModel->getMustPay();
		$this->load->view(__ADMIN_TEMPLATE__. "/oa/CmfYingshoukuanhuizong/index",$data);
	}
