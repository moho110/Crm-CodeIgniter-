...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfCrmFinishstate/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">完成状态列表 <a href="<?php echo site_url('oa/CmfCrmFinishstate/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfCrmFinishstate->name; ?></td>
                            <td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">完成状态列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $link; ?></p>
