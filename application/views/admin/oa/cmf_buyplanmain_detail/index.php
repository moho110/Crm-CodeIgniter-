...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfBuyplanmainDetail/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">采购计划明细列表 <a href="<?php echo site_url('oa/CmfBuyplanmainDetail/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfBuyplanmainDetail->prodname; ?></td>
                            <td><?php echo $CmfBuyplanmainDetail->jine; ?></td>
                            <td>
