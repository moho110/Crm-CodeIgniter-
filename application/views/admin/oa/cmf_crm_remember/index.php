...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfCrmRemember/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">纪念日列表 <a href="<?php echo site_url('oa/CmfCrmRemember/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th width="5%">编号</th>
                            <th width="30%">纪念日日期</th>
                            <th width="50%">创建时间</th>
                            <th width="15%">动作</th>
                        </tr>
                    </thead>
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfCrmRemember->mem_date; ?></td>
                            <td><?php echo $CmfCrmRemember->createtime; ?></td>
                            <td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">纪念日列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $links; ?> </p>
