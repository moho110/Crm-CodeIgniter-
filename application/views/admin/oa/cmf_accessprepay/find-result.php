...
<div class="container">
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">预收款记录查询结果<a href="<?php echo site_url('/oa/CmfAccessprepay/'); ?>" class="glyphicon glyphicon-arrow-left pull-right"></a></div>
            <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">预收款记录查询结果列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
