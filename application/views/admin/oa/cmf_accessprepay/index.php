...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfAccessprepay/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">预付款记录 <a href="<?php echo site_url('oa/CmfAccessprepay/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfAccessprepay->jine; ?></td>
                            <td><?php echo $CmfAccessprepay->createman; ?></td>
                            <td><?php echo $CmfAccessprepay->createtime; ?></td>
                            <td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">预付款记录未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $links; ?></p>
