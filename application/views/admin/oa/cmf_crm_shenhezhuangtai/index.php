...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfCrmShenhezhuangtai/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">审核状态列表 <a href="<?php echo site_url('oa/CmfCrmShenhezhuangtai/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfCrmShenhezhuangtai->name; ?></td>
                            <td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">审核状态列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $links; ?></p>
