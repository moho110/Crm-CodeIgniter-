...
<div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfKaipiaorecord/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">开票记录列表 <a href="<?php echo site_url('oa/CmfKaipiaorecord/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfKaipiaorecord->piaojujine; ?></td>
                            <td><?php echo $CmfKaipiaorecord->createtime; ?></td>
                            <td>
                                ...
                                <a href="<?php echo site_url('oa/CmfKaipiaorecord/delete/'.$CmfKaipiaorecord->id); ?>" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete?')"></a>
                            </td>
                        </tr>
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">开票记录列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $links; ?></p>
