    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo $action; ?> 库存更换 <a href="<?php echo site_url('/oa/CmfStockchangemain/'); ?>" class="glyphicon glyphicon-arrow-left pull-right"></a></div>
                <div class="panel-body">
                    <form method="post" action="" class="form">
                        <div class="form-group">
                            <label for="billid">清单ID：</label>
                            <input type="text" class="form-control" name="billid" placeholder="Enter billid" value="<?php echo !empty($cmf_stockchangemain['billid'])?$cmf_stockchangemain['billid']:''; ?>">
                            <?php echo form_error('billid','<p class="help-block text-danger">','</p>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="zhuti">主题：</label>
                            <input type="text" class="form-control" name="zhuti" placeholder="Enter zhuti" value="<?php echo !empty($cmf_stockchangemain['zhuti'])?$cmf_stockchangemain['zhuti']:''; ?>">
                            <?php echo form_error('zhuti','<p class="help-block text-danger">','</p>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="createman">创建人：</label>
                            <input type="text" class="form-control" name="createman" placeholder="Enter createman" value="<?php echo !empty($cmf_stockchangemain['createman'])?$cmf_stockchangemain['createman']:''; ?>">
                        ...
                        <div class="form-group">
                            <label for="outstoreid">出库ID：</label>
                            <input type="text" class="form-control" name="outstoreid" placeholder="Enter outstoreid" value="<?php echo !empty($cmf_stockchangemain['outstoreid'])?$cmf_stockchangemain['outstoreid']:''; ?>">
                            <?php echo form_error('outstoreid','<p class="help-block text-danger">','</p>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="instoreid">入库ID：</label>
                            <input type="text" class="form-control" name="instoreid" placeholder="Enter instoreid" value="<?php echo !empty($cmf_stockchangemain['instoreid'])?$cmf_stockchangemain['instoreid']:''; ?>">
                        ...
                        <div class="form-group">
                            <label for="outstoreshenhe">出库审核：</label>
                            <input type="text" class="form-control" name="outstoreshenhe" placeholder="Enter outstoreshenhe" value="<?php echo !empty($cmf_stockchangemain['outstoreshenhe'])?$cmf_stockchangemain['outstoreshenhe']:''; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="memo" cols="140" rows="10" style="resize: none;">
                                <?php echo !empty($cmf_stockchangemain['memo'])?$cmf_stockchangemain['memo']:''; ?>
                            </textarea>
                            <?php echo form_error('memo','<p class="help-block text-danger">','</p>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="totalmoney">总金额：</label>
                            <input type="text" class="form-control" name="totalmoney" placeholder="Enter totalmoney" value="<?php echo !empty($cmf_stockchangemain['totalmoney'])?$cmf_stockchangemain['totalmoney']:''; ?>">
