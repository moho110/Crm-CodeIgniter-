...
<div class="panel panel-default">
    <div class="panel-heading">
        <form action="<?php echo site_url('oa/CmfCrmPiaojuType/search'); ?>" method="post">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default ">
                <div class="panel-heading">票据类型列表 <a href="<?php echo site_url('oa/CmfCrmPiaojuType/add'); ?>" class="glyphicon glyphicon-plus pull-right" ></a></div>
                <table class="table table-striped">
                    ...
                    <tbody id="userData">
                        ...
                        <tr>
                            ...
                            <td><?php echo $CmfCrmPiaojuType->billType; ?></td>
                            <td>
                        ...
                        <?php endforeach; else: ?>
                        <tr><td colspan="4">票据类型列表未找到......</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                <p><?php echo $links; ?></p>
